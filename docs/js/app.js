 ...
 */
                ...
                return function() {
                    ...
                    function r(n) {
                        var i, a, r = Array.prototype.slice.apply(n.attributes).filter((function(t) {
                            ...
                            return t[0 === e.name.indexOf("data-") ? e.name.split("data-")[1] : e.name] = e.value, 
                            t;
                        }), {}), l = t({}, e, r, {
                            y: n.offsetTop,
                            originalSrc: r.src,
                    ...
                    function u() {
                        var t = this, i = window.innerHeight, o = n.length, a = function(e, n) {
                            e.settings.initialized = !0, e.el.classList.add("lazyframe--loaded"), o--, l(e), 
                            e.settings.initinview && e.el.click(), e.settings.onLoad.call(t, e);
                        };
                        n.filter((function(t) {
                    ...
                    function c(t, i) {
                        if (t.iframe = function(t) {
                            ...
                            n.setAttribute("id", "lazyframe-".concat(t.id)), n.setAttribute("src", t.src), n.setAttribute("frameborder", 0), 
                            n.setAttribute("allowfullscreen", ""), t.autoplay && (n.allow = "accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture");
                            return e.appendChild(n), e;
                        }(t.settings), t.settings.thumbnail && i && (t.el.style.backgroundImage = "url(".concat(t.settings.thumbnail, ")")), 
                        t.settings.title && 0 === t.el.children.length) {
                            var a = document.createDocumentFragment(), r = document.createElement("span");
                            r.className = "lazyframe__title", r.innerHTML = t.settings.title, a.appendChild(r), 
                            t.el.appendChild(a);
                        }
                        e.lazyload || (t.el.classList.add("lazyframe--loaded"), t.settings.onLoad.call(this, t), 
                        n.push(t)), t.settings.initialized || n.push(t);
                    }
                    return function(n) {
 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        da.init();
        var lazyframe_min = __webpack_require__(309);
        lazyframe_min(".lazyframe");
        let script_elements = document.querySelectorAll(".lazyframe");
        lazyframe_min(script_elements);
