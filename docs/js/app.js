 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        if (inputPhone) {
            ...
            const handleChange = () => {
                let text;
                if (inputPhone.value) text = iti.isValidNumber() ? "Номер вірний: " + iti.getNumber() : "Невірно введений номер - будь ласка, спробуйте ще раз"; else text = "Будь ласка, введіть номер телефону";
